...
# ╔═╡ fef7185e-591f-11f0-1f4c-17f5520a1fbd
begin
...
# ╔═╡ 75e1f43e-606f-4a10-a782-b8439e7d8a60
md"""
# Bootstrap
"""
...
md"""
Dado uma a.a. que segue `` X ∼ N(\mu, \sigma^2) `` com ``n = 5, 20, 100`` e ``1000``, além disso considere ``\mu = 100`` e ``\sigma = 10`` faça a comparação entre o método bootstrap com o resultado teórico e analítico, consdere 10000 como o tamanho da amostra do bootstrap.

1. Analise o historgrama (e o hist. suavizado via kernels) dos ``\bar{x}``'s gerados via bootstrap e compará-los com a distribuição verdadeira de ``\bar{X}_n`` e a distribuição estimada de ``\bar{X}_n``via teoria;

2. Avalie o IC a um nível de confiança de 95%.
"""

# ╔═╡ 72d0af07-f12b-4065-a04f-4d66eddaa5d4
@bind n Slider([5, 20, 100, 1000], show_value=true)
...
begin
	...
	btsp_sigma_conhecido = [mean(rand(Normal(X_bar, σ), n)) for _ in 1:nr]
...
md"""
Distribuições originais, feitas sem o uso do bootstrap.
"""

# ╔═╡ b22d28e4-4c8f-4bb1-b704-495c77b0ec2b
begin
	plot(50:150, x->pdf.(𝒩, x), linewidth=2, label="Normal verdadeira", legendfontsize=5)
	plot!(x->pdf(Normal(X_bar, σ), x), label="σ conhecido")
	plot!(x->pdf(Normal(X_bar, σ_bar), x), label="Params. estimados")
	xlims!(70, 130)
end

# ╔═╡ dcd426a0-5432-4809-858b-931136beb5c4
md"""
## Avaliação do Bootstrap
"""

# ╔═╡ ef4f7d21-041d-4a79-a221-892b6a9691e2
md"""
Distribuições feitas com o uso do bootstrap comparada com a verdadeira
"""

# ╔═╡ 121fc82b-554d-4742-9937-35bac195f127
begin
	density(btsp_sigma_conhecido, label="Amostra do Btsp. σ conhecido", legendfontsize=5)
	density!(btsp_param_estimados, label="Amostra do Btsp. param. estimados")
	density!(btsp_n_param, label="Amostra do Btsp. nenhum param. conhecido")
	plot!(x->pdf.(Normal(μ, σ/n^.5), x), linewidth=2, label="Normal verdadeira")
end
...
begin
	...
	**Amostra com sigma conhecido**
	...
	Limite inferior: $IC_li_sigma
	
	Limite superior: $IC_ls_sigma
	"""
end
...
manifest_format = "2.0"
project_hash = "6a19b7943ae39ee49392af12a7a2674788632d5e"
