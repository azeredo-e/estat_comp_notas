...
# ╔═╡ c6da336d-9967-4f54-ac02-89efde3d5d2b
begin
	...
	using DataFrames
	using MLJ
	import MLJDecisionTreeInterface, EvoTrees
end

# ╔═╡ 4564af8a-7771-11f0-3d30-2b219ecf3ff7
md"""
# Árvores de Regressão, Bagging e Random Forest
"""

# ╔═╡ 6beaccec-f82b-4e62-bbd2-375af921b81c
md"""
## Exercício
(vira questão 3 da lista final)
...
# ╔═╡ 9c5a3b4a-2c88-4ba0-8e1b-6015935f2d3a
begin
	nr = 10_000
...
# ╔═╡ b7cb66a0-c31b-4667-a5be-79896a366dda
begin
	X = rand(𝒰, n, q)
...
# ╔═╡ 3e5d8187-e23a-41fa-a608-3da5e10235d6
md"""
### Árvore de Decisão
"""

# ╔═╡ 3c1edceb-bc19-4254-9f7c-c4b871d69d96
DecisionTreeRegressor = @load DecisionTreeRegressor pkg=DecisionTree

# ╔═╡ d8eb20f2-d94d-4384-868e-8e4c4fb62631
model = DecisionTreeRegressor(
	max_depth=5
)

# ╔═╡ 2e6444c4-e9b7-4612-86c5-37c5f49228a7
mach = machine(model, X_train, y_train) |> fit!

# ╔═╡ ad80d288-a646-417f-94ae-be70afcabd85
y_hat = MLJ.predict(mach, X_test)

# ╔═╡ 9a82b13e-9831-4915-8f58-19341890e62e
scatter(y_test, y_hat,
		# ylims=(0, 10), xlims=(0, 10)
	)

# ╔═╡ 51830e69-0bfa-40ff-a1d4-cfdb0cdf1582
fitted_params(mach)
...
manifest_format = "2.0"
project_hash = "f68a6fae01dd2dfc24d7ef3ad67b7e8df756c934"
...
git-tree-sha1 = "a5e04a7b056002cba9583012d24a66a6c0ae7735"
